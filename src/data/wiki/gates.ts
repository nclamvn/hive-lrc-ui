...
export const gates: Milestone[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      b("Measure real pruning, branching, certificate size, surviving-state count and projected campaign cost. The D23 5000/5000 and 7/7 stay bounded pilot measurements. No compute-budget increase; no GLOBAL-WITNESS; BASE-SURVIVOR escalates to D20-R. LRC(13) OPEN", "Đo pruning thật, branching, cỡ chứng chỉ, số trạng thái sống sót và chi phí chiến dịch dự phóng. Các số 5000/5000 và 7/7 của D23 vẫn là đo pilot có chặn. Không tăng ngân sách compute; không GLOBAL-WITNESS; BASE-SURVIVOR leo thang tới D20-R. LRC(13) MỞ"),
    ],
    artifacts: 0,
  },
];
