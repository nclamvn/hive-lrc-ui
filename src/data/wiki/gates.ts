...
export const gates: Milestone[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      b("Mandatory regression: p=197 base cover YES, p=197 level-14 PROPER, D23 early cut FIRES before full reconstruction. Never wait for full reconstruction to ask 13-integer-square realizability or level-14 survival. No compute-budget increase; no GLOBAL-WITNESS; BASE-SURVIVOR escalates to D20-R. LRC(13) OPEN", "Regression bắt buộc: phủ nền p=197 YES, level-14 p=197 PROPER, cut sớm D23 KÍCH HOẠT trước tái dựng đầy đủ. Không bao giờ đợi tái dựng đầy đủ mới hỏi khả năng sinh 13-bình-phương-nguyên hay sống sót level-14. Không tăng ngân sách compute; không GLOBAL-WITNESS; BASE-SURVIVOR leo thang tới D20-R. LRC(13) MỞ"),
    ],
    artifacts: 0,
  },
];
