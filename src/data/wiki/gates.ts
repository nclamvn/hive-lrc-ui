...
export const gates: Milestone[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      b("Mandatory regression: p=197 base cover YES, t=1/14 lonely YES, adaptive early cut FIRES. No compute-budget increase; no GLOBAL-WITNESS; BASE-SURVIVOR escalates to D20-R. LRC(13) OPEN", "Regression bắt buộc: phủ nền p=197 YES, t=1/14 cô đơn YES, cut sớm thích nghi KÍCH HOẠT. Không tăng ngân sách compute; không GLOBAL-WITNESS; BASE-SURVIVOR leo thang tới D20-R. LRC(13) MỞ"),
    ],
    artifacts: 0,
  },
];
