...
export const gates: Milestone[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      b("Two verifiers ACCEPT, 158 of 158 corruption rejected; pilot passes with the mandatory padding-required case and timeout injection. Honest boundary: per-query wall removed, full-campaign seeding via meet-in-the-middle still open, no campaign verdict claimed. LRC(13) OPEN", "Hai verifier CHẤP NHẬN, 158 trên 158 tấn công bị bác; pilot đạt với ca padding-bắt-buộc và tiêm timeout. Ranh giới trung thực: tường mỗi-truy-vấn đã gỡ, seed chiến dịch qua gặp-nhau-ở-giữa vẫn mở, chưa tuyên bố verdict chiến dịch. LRC(13) MỞ"),
    ],
    artifacts: 11,
  },
];
