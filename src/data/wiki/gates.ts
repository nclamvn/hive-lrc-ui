...
export const gates: Milestone[] = [
  ...
  },
  {
    ...
    checks: [
      ...
      b("Scope correction accepted: D21-S blocks only the two explicit materialization routes, not every implicit method. No compute-budget increase; no GLOBAL-WITNESS; any BASE-SURVIVOR escalates to D20-R. LRC(13) OPEN", "Sửa phạm vi chấp nhận: D21-S chỉ chặn hai route hiện thực hóa tường minh, không phải mọi cách implicit. Không tăng ngân sách compute; không GLOBAL-WITNESS; mọi BASE-SURVIVOR leo thang tới D20-R. LRC(13) MỞ"),
    ],
    artifacts: 0,
  },
];
